...
;
        ...
        <div class="container">
            ...
            <select class="selectpicker" data-width="auto" id="restaurant" name="restaurant" required>
                <option value="" disabled selected>Restaurant</option>
                <?php
                    foreach($restaurantNameArray as $restaurantName)
                    {
                        echo '<option value ="'.$restaurantName[0].'">'.$restaurantName[1].'</option>';
                    }
                ?>
            ...
            <br>
            <br>
            <input class="btn btn-default" type="submit" value="Make Reservation" name="submit">
        </form>
        </div>
